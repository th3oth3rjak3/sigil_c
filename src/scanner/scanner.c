...
/// Scanner is the state which is used to keep track of source code
/// scanning.
typedef struct {
    const char* start;   // The start of the current lexeme.
    const char* current; // The current byte in the lexeme.
    int         line;    // The current line number in the source code.
} Scanner;

/// A global scanner instance.
Scanner scanner;
